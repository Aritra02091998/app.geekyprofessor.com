...
<head>
    ...
    <title>Convert PNG to JPG Online Free</title>

    <meta name="description" content="Convert PNG to JPG online for free with this online PNG to JPG converter. PNG to JPG free convert in just 5 seconds while preserving the quality of the image instantly."/>

    <meta name="keywords" content="png to jpg,convert to png to jpg,convert png to jpg,png to jpg converter,png to jpg mac,png to jpg free convert,png to jpg online,png to jpg iphone,can you convert png to jpg,from png to jpg,converter png to jpg">

    <link rel="stylesheet" href="css/convertPNGtoJPGOnline.css">
...
<body>
  ...
  <div class="container">
    ...
    <div class="drag-area">
      ...
      <form name="imgUpload" id="imageForm" method="post" action="handlers/handleConvertPNGtoJPGOnline.php" enctype="multipart/form-data">
  ...
  <script src="js/convertPNGtoJPGOnline.js"></script>
