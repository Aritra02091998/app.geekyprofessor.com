...
<head>
    ...
    <title>Convert JPG to WebP free Online with Quality Savings</title>

    <meta name="description" content="Convert JPG to WebP online for free with this online JPG to WebP converter. Convert to WebP format in just 
5 seconds while preserving the quality of the image instantly."/>

    <meta name="keywords" content="converter to webp,convert to webp format,convert to webp,convert image to webp,how to convert jpg to webp,convert jpg webp,convert jpg to webp,what is webp image,jpg to webp converter,webp vs jpeg">

    <link rel="stylesheet" href="css/convertJPGtoWebPOnline.css">
...
<body>
  ...
  <div class="container">
    ...
    <div class="drag-area">
      ...
      <form name="imgUpload" id="imageForm" method="post" action="handlers/handleConvertJPGtoWebPOnline.php" enctype="multipart/form-data">
  ...
  <script src="js/convertJPGtoWebPOnline.js"></script>
