                        ...
                        <div class="card bg-light border-0 h-100">
                            <a href="png-to-jpg-online.php">
                                <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                    ...
                                    <h2 class="fs-4 fw-bold">Free Online PNG to JPG Converter</h2>
                                    <p class="mb-0">Convert PNG to JPG with our free converter PNG to JPG online while preserving the high JPEG Image quality.</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-xxl-4 mb-5">
                        <div class="card bg-light border-0 h-100">
                            <a href="convert-pdf-to-jpg.php">
                                <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                    <div class="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4"><i class="bi bi-file-text-fill"></i></div>
                                    <h2 class="fs-4 fw-bold">Convert PDF to JPG Online</h2>
                                    <p class="mb-0">Convert your whole PDF document to JPG images page by page online for free in a Zip folder.</p>
                                </div>
                            </a>
                        </div>
                    </div>
