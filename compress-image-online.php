...
<!-- This is the compressDash = compress Dashboard where user will upload image -->
...
<head>
    ...
    <meta name="description" content="Compress image online of any format JPG, JPEG, PNG and GIF instantly while preserving the quality of the image. Free online JPG image compresser to compress JPEG images."/>

    <meta name="keywords" content="image compresser,image compression,compress image,compress image size,compress image online,how to compress an image,compress image jpeg,compress image without losing quality,compress image on mac,compress image android,image compression online">

    <link rel="stylesheet" href="css/compressImageOnline.css">
...
<body>
  <div class="heading">
    <h1>Compress Image Online Free - JPG, JPEG, PNG and GIF</h1>
    <p id="seoContent">
      Best image compresser which can compress any image format instantly while preserving the original quality  of the image.
    </p>
  </div>
  <div class="drag-area">
    ...
    <form name="imgUpload" id="imageForm" method="post" action="handlers/handleCompressImageOnline.php" enctype="multipart/form-data">
  ...
  <script src="js/compressImageOnline.js"></script>
